...
#include "STM32ADC.h"
    ...
    void begin() {
        ...
        LL_ADC_SetClock(_adc, LL_ADC_CLOCK_SYNC_PCLK_DIV2); // Use PCLK/2 to avoid duty cycle issues
        LL_ADC_SetResolution(_adc, LL_ADC_RESOLUTION_12B);
        LL_ADC_SetDataAlignment(_adc, LL_ADC_DATA_ALIGN_RIGHT);
        LL_ADC_SetLowPowerMode(_adc, LL_ADC_LP_MODE_AUTOOFF);
        LL_ADC_SetSamplingTimeCommonChannels(_adc, LL_ADC_SAMPLINGTIME_1CYCLE_5);
        ...
        LL_ADC_REG_SetSequencerChannels(_adc, LL_ADC_CHANNEL_0);
